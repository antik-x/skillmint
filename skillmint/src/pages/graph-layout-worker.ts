// Web Worker: ForceAtlas2 layout off the main thread (avoids UI jank on large graphs).
// Adapted from llm_wiki/src/components/graph/graph-layout-worker.ts.
// Receives raw nodes/edges arrays (format-agnostic) and returns computed positions.
