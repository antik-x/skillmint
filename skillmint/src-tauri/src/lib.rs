...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::update_skill_status,
            commands::read_skill_content,
            commands::save_skill_content,
            commands::check_skill_external_change,
            ...
            commands::promote_to_global,
            commands::remove_project,
            commands::get_skill_bindings,
            commands::add_skill_binding,
            commands::remove_skill_binding,
            commands::create_project_skill,
            // PRD-01 patch: project detail page + multi-version skills
            commands::get_project_detail,
            commands::resolve_skill_link_command,
            commands::install_skill_to_project,
            commands::list_skill_versions_command,
            commands::resolve_skill_diff_command,
            commands::pin_binding_version,
            commands::delete_skill_version,
            commands::set_version_note,
            commands::get_version_note,
